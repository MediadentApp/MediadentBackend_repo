...
const responseMessages = {
    AUTH: {
        ...
        REDIRECT_TO_INTERESTS: 'Please choose your interests to access this resource',
        REDIRECT_TO_LOGIN: 'Please log in to access this resource',
        REDIRECT_TO_SIGNUP: 'Please sign up to access this resource',
        REDIRECT_TO_FORGOT_PASSWORD: 'Please reset your password to access this resource',
        SIGNUP_USER_ALREADY_EXISTS: 'User already exists, please log in using your email and password',
        LOGIN_OTHER_SERVICE: 'This email is registered with another login service. Please use that service to log in.',
        ...
        OTP_ALREADY_SENT: `Please wait {{time}} before requesting a new OTP.`,
        ...
        PASSWORD_RESET_SENT_ERROR: 'There was an error sending the email. Please try again later.',
    },
    SOCKET: {
