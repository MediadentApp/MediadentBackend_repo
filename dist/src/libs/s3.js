...
import { getS3KeyFromUrl } from '../utils/index.js';
...
export const uploadToS3 = async (file, bucketName = defaultS3BucketName) => {
    if (!bucketName) {
 ...
 */
export const deleteImagesFromS3 = async (urls, bucketName = defaultS3BucketName) => {
    if (urls.length === 0)
        return;
