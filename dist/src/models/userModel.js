...
import { Chat } from '../models/userMessages.js';
...
import { UserRole, UserType } from '../types/enum.js';
...
userSchema.statics.protectApi = async function (token, selectFields = '', populateFields) {
    ...
    if (!token)
        throw new ApiError(responseMessages.AUTH.NO_TOKEN, 401, ErrorCodes.SIGNUP.REDIRECT_TO_LOGIN, redirect);
