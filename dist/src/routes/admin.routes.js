import { getAccessLogs, deleteAllAccessLogs, deleteCommunity, deletePost, deleteUser, getAllCommunities, getAllPosts, getAllUsers, getBannedIPs, banIP, unbanIP, } from '../controllers/adminController.js';
